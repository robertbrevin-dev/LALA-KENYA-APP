...
# Find and replace the old 3-button block
OLD = """              {booking.booking_status === 'accepted' && (
...
NEW = """              {booking.booking_status === 'accepted' && !payType && (
                <div className="px-4 py-4 space-y-2.5">
...
if OLD in c:
    ...
    print("PATTERN NOT FOUND - checking nearby...")
    idx = c.find("Pay Deposit - Ksh 1,000")
    print(f"'Pay Deposit - Ksh 1,000' at index: {idx}")
